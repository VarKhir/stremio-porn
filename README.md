...
- `STREMIO_PORN_USENET_STREAMER` — base URL to a compatible Usenet addon (e.g. `https://example.com/<token>`); trailing slashes are trimmed automatically and streams for IMDb/TMDb/TVDB ids will be proxied to that addon
