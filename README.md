...
- `STREMIO_PORN_USENET_STREAMER` — base URL (without trailing slash) to a compatible Usenet addon (e.g. `https://example.com/<token>`); when set, streams for IMDb/TMDb/TVDB ids will be proxied to that addon
